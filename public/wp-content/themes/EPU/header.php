...
<header class="site-header">
    <div class="container">
      <h1 class="school-logo-text float-left"><a href="<?php echo esc_url(site_url()); ?>"><strong>EPU - </strong> <small>A Ficticious University</small></a></h1>
      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          <!-- check to see if user is logged in. Display proper navigation -->
          <?php 
